...
export const projectsData = [
  {
    ...
    workforceCount: "85",
    action: "action",
    projectDetail: "This project focuses on improving the operational efficiency of our workforce through targeted training and resource allocation. The goal is to streamline processes and ensure that every team member is equipped with the necessary tools and knowledge to perform their duties effectively. This project will serve as a benchmark for future initiatives aimed at enhancing productivity across the organization."
  },
  {
  ...
  },
  {
    ...
    workforceCount: "20",
    action: "action",
    projectDetail: "This project is focused on enhancing the safety protocols within our workforce. The initiative aims to introduce new safety training programs, conduct regular safety audits, and implement advanced safety equipment. This will ensure that our workforce operates in a secure environment, reducing the risk of accidents and improving overall job satisfaction."
  },
  {
  ...
  },
  {
    ...
    workforceCount: "90",
    action: "action",
    projectDetail: "This project is centered around the introduction of a new employee wellness program. The program will include mental health resources, fitness challenges, and wellness workshops aimed at improving the overall well-being of our workforce. By fostering a healthier work environment, we aim to boost morale and increase productivity."
  },
  {
...
export const allContractorsData = [
  ...
  },
  {
    ...
    totalScore: "70",
    violationType: ['Visitor exceeds the time allowed to visit', 'Late check-in'],
  },
  {
  ...
  },
  {
    ...
    totalScore: "67",
    violationType: ['Visitor exceeds the time allowed to visit', 'Unauthorized access'],
  }
];
